...
![System Architecture](/img/cmu15-445/c22/image.webp)
...
![Homogeneous VS Heterogeneous](/img/cmu15-445/c22/image-5.webp)
...
![Vertical Partitioning](/img/cmu15-445/c22/image-7.webp)
...
![Horizontal Partitioning](/img/cmu15-445/c22/image-8.webp)
...
![Consistent Hashing](/img/cmu15-445/c22/image-11.webp)
...
![Centralized Coordinator](/img/cmu15-445/c22/image-12.webp)

拿到鎖之後才能修改資料，修改完畢後再向 coordinator 發送 commit 請求，coordinator 會向所有的分區詢問這個交易是否可以 commit，最後返還 ACK 給使用者。

![Centralized Coordinator](/img/cmu15-445/c22/image-13.webp)

#### Middleware

這種 coordinator 可以被當成一個 middleware，負責協調所有的交易。

![Middleware](/img/cmu15-445/c22/image-14.webp)

### Decentralized Coordinator

再去中心化的架構中，執行某個交易時會選擇一個節點作為 master，負責協調所有的交易。

![Decentralized Coordinator](/img/cmu15-445/c22/image-15.webp)
...
![Distributed Concurrency Control](/img/cmu15-445/c22/image-17.webp)
...
![Federated Database](/img/cmu15-445/c22/image-16.webp)
