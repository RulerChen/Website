...
![Write Skew Anomaly](/img/cmu15-445/c19/image-4.webp)

### Example

$T_1$ 先修改 $A$，創造一個新的版本 $A_1$，並將 $A_0$ 的結束時間改成 1。

![MVCC Example](/img/cmu15-445/c19/image.webp)

此時 $T_2$ 想讀取 $A$，因為 $T_1$ 還沒提交，所以 $T_2$ 只能讀取 $A_0$。

![MVCC Example](/img/cmu15-445/c19/image-1.webp)

接著 $T_2$ 想要修改 $A$，但是有另一個 active 的事務正在修改 $A$，所以 $T_2$ 會被 block。

![MVCC Example](/img/cmu15-445/c19/image-2.webp)

直到 $T_1$ commit 之後，$T_2$ 才能創建新的版本 $A_2$，並將 $A_1$ 的結束時間改成 2。

![MVCC Example](/img/cmu15-445/c19/image-3.webp)
...
![Append-Only Storage](/img/cmu15-445/c19/image-5.webp)
...
![Time-Travel Storage](/img/cmu15-445/c19/image-6.webp)
...
![Delta Storage](/img/cmu15-445/c19/image-7.webp)
...
![Background Vacuuming](/img/cmu15-445/c19/image-9.webp)
...
![Cooperative Cleaning](/img/cmu15-445/c19/image-11.webp)
...
![Transaction-level GC](/img/cmu15-445/c19/image-12.webp)
...
![Physical Pointers](/img/cmu15-445/c19/image-13.webp)
...
![Logical Pointers](/img/cmu15-445/c19/image-14.webp)
...
![MVCC Duplicate Key Problem](/img/cmu15-445/c19/image-16.webp)
...
![Summary](/img/cmu15-445/c19/image-17.webp)
