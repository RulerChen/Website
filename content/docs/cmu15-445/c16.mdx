...
![Isolation](/img/cmu15-445/c16/image.webp)
...
![Unrepeatable Read](/img/cmu15-445/c16/image-3.webp)

#### Write-Read Conflict

當一個交易可以讀取到另一個交易尚未提交的值時，就是 write-read conflict (dirty read)。

![Dirty Read](/img/cmu15-445/c16/image-4.webp)

#### Write-Write Conflict

當兩個交易修改同一個資源，卻有一個交易被完全覆蓋時，就是 write-write conflict (lost update)。

![Lost Update](/img/cmu15-445/c16/image-5.webp)
...
![Serializability Overview](/img/cmu15-445/c16/image-7.webp)
...
![Dependency Graph](/img/cmu15-445/c16/image-6.webp)
...
![View Serializability](/img/cmu15-445/c16/image-8.webp)
![View Serializability](/img/cmu15-445/c16/image-9.webp)
