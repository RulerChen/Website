...
![BASIC T/O Example](/img/cmu15-445/c18/image-1.webp)
...
![Phantom Problem Example](/img/cmu15-445/c18/image-8.webp)
...
![Hierarchical Locking](/img/cmu15-445/c18/image-9.webp)
...
![SQL-92 Isolation Level Standards](/img/cmu15-445/c18/image-10.webp)

並非所有的資料庫都支持所有的 isolation level，因此需要查看相應的文件。

![DB Isolation Levels](/img/cmu15-445/c18/image-11.webp)
...
![Isolation Levels](/img/cmu15-445/c18/image-12.webp)
