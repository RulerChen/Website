...
![Iterator Model](/img/cmu15-445/c13/image.webp)
...
![Materialization Model](/img/cmu15-445/c13/image-1.webp)
...
![Vectorized / Batch Model](/img/cmu15-445/c13/image-2.webp)
...
![Expression Evaluation](/img/cmu15-445/c13/image-4.webp)
...
![Process per Worker](/img/cmu15-445/c13/image-6.webp)
...
![Thread per Worker](/img/cmu15-445/c13/image-7.webp)
...
![Intra-Operator Parallelism](/img/cmu15-445/c13/image-8.webp)
...
![Inter-Operator Parallelism](/img/cmu15-445/c13/image-9.webp)

### Bushy Parallelism

Bushy Parallelism 是 Intra-Operator 和 Inter-Operator Parallelism 的混合形式。

![Bushy Parallelism](/img/cmu15-445/c13/image-10.webp)
...
![Multi-Disk I/O Parallelism](/img/cmu15-445/c13/image-11.webp)
