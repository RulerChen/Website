...
![Storage Hierarchy](/img/cmu15-445/c03/image.webp)
...
![Disk-Oriented DBMS Overview](/img/cmu15-445/c03/image-2.webp)
...
![Heap File Linked List Example](/img/cmu15-445/c03/image-3.webp)

#### Page Directory

儲存一個目錄頁，用於告訴我們那些 page 是存在哪裡，DBMS 需要保證 directory page 跟 data page 是同步的。

![Heap File Page Directory Example](/img/cmu15-445/c03/image-4.webp)
...
![Strawman Idea](/img/cmu15-445/c03/image-6.webp)
...
![Slotted Page](/img/cmu15-445/c03/image-7.webp)
...
![MemTable and SSTable Example - 1](/img/cmu15-445/c03/image-22.webp)
![MemTable and SSTable Example - 2](/img/cmu15-445/c03/image-21.webp)
...
![Log-Structured Storage Compaction](/img/cmu15-445/c03/image-11.webp)
...
![Universal Compaction and Level Compaction](/img/cmu15-445/c03/image-12.webp)
...
![Index-Organized Storage](/img/cmu15-445/c03/image-13.webp)
...
![Tuple Data Alignment](/img/cmu15-445/c03/image-14.webp)
...
![Padding](/img/cmu15-445/c03/image-15.webp)

#### Reordering

將資料重新排序 (可能需要再填充)，使其對齊。

![Reordering](/img/cmu15-445/c03/image-16.webp)

## Data Representation

最後就來介紹不同的資料型態是如何被儲存的。

![Data Representation Overview](/img/cmu15-445/c03/image-17.webp)
...
![Large Value Storage](/img/cmu15-445/c03/image-18.webp)

### External Value Store

有些資料庫可以存取外部的檔案，這些檔案會被放在本地的路徑並儲存 URL，資料庫不能做任何更改，也不保證 transaction。

![External Value Store](/img/cmu15-445/c03/image-19.webp)
