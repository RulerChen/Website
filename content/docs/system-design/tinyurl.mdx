...
舉例來說，使用者可以將 `https://www.example.com/some/url` 丟給 TinyURL，TinyURL 會回傳一個短網址 `https://tinyurl.com/abc123`，當其他人訪問這個短網址時，會被重定向到 `https://www.example.com/some/url`。
...
![TinyURL High Level Design](/img/system-design/tinyurl/image.webp)
...
<Accordions type="single">
  <Accordion title="Hash Collision">
...
```python title="hash_short_url.py"
import hashlib
import os
...
```python title="random_short_url.py"
import random
import string
...
![TinyURL Final Design](/img/system-design/tinyurl/image-2.webp)
