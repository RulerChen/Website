      ...
      <div className="relative z-10 max-w-[1000px] mx-auto px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20">
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-2 mt-12 sm:mt-16">
            <Link
              href={validPage > 1 ? `/blog?page=${validPage - 1}` : '/blog'}
              className={`flex items-center justify-center w-10 h-10 rounded-lg glass-card transition-all duration-300 ${
                validPage <= 1
                  ? 'opacity-50 pointer-events-none'
                  : 'hover:translate-y-[-2px] hover:text-[var(--accent-warm)]'
              }`}
                ...
                <Link
                  ...
                  className={`flex items-center justify-center w-10 h-10 rounded-lg transition-all duration-300 ${
                    pageNum === validPage
                      ...
                      : 'glass-card hover:translate-y-[-2px] hover:text-[var(--accent-warm)]'
                  }`}
                  style={{ fontFamily: 'var(--font-mono)' }}
                >
                  {pageNum}
